(function() {
  ...
  describe('aws-translators', function() {
    ...
    describe('#query', function() {
      ...
      it('should translate the response', function() {
        return lib.query.call(dynastyTable, {
      ...
      return it('should call query', function() {
        sandbox.spy(dynastyTable.parent.dynamo, "queryAsync");
        ...
        expect(dynastyTable.parent.dynamo.queryAsync.calledOnce);
        return expect(dynastyTable.parent.dynamo.queryAsync.getCall(0).args[0]).to.include.keys('TableName', 'IndexName', 'KeyConditions');
      });
    });
  ...
  describe('Dynasty', function() {
    describe('Base', function() {
      ...
      return describe('create()', function() {
        ...
        it('should accept a hash and range key_schema', function() {
          var promise;
          promise = this.dynasty.create(chance.name(), {
            key_schema: {
              hash: [chance.name(), 'string'],
        ...
        return it('should accept global secondary indexes', function() {
          var hash, promise, range;
          hash = chance.name();
          range = chance.name();
          promise = this.dynasty.create(chance.name(), {
            key_schema: {
